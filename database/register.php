...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tabel_customer (nama, alamat, NoHP, username, password) VALUES ('$nama', '$alamat', '$NoHP', '$username', '$password')";
...
<body>
    <form action="register.php" method="post">
        ...
        <input type="text" id="nama" name="IdCustomer" required><br>

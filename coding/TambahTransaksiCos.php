...
<body>
        ...
        <div id="content">
            ...
            <form role="form" method="post" enctype="multipart/form-data" onsubmit="return validasi()" name="biodata">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="IdTransaksi">
              </div>
              <div class="form-group">
                <label>ID Transaksi</label>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="date" name="Pengambilan"  >
              </div>
              <br>
    ...
    <?php
        if (isset($_POST['cek'])) {
            ...
            $sql2 = "INSERT INTO tbtransaksi (IdTransaksi, IdCustomer, IdPaket, Berat, HargaTotal, Pengambilan) VALUES (?, ?, ?, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $sql2);
            mysqli_stmt_bind_param($stmt, "ssssss", $idtransaksi, $idcustomer, $idpaket, $berat, $hargatotal, $pengambilan);

            if (mysqli_stmt_execute($stmt)) {
                echo "<script>alert('Data Transaksi Berhasil Diinput');</script>";
                echo "<script> location = 'TampilTransaksiCos.php'</script>";
            } else {
                // Tampilkan pesan error spesifik jika query gagal

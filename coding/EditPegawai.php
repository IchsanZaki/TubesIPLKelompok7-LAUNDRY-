...
session_start();
$id = $_GET['id'];
$data = mysqli_query($conn,"SELECT * FROM tbpegawai where IdPegawai='$id'");
...
<body>
        ...
        <div id="content">
            ...
            <form role="form" method="post" enctype="multipart/form-data" onsubmit="return validasi()" name="biodata">
              <div class="form-group">
                ...
                <input class="form-control" type="hidden" name="IdPegawai" value="<?php echo $d['IdPegawai'];?>">
                <input class="form-control" type="Text" name="IdPegawai" value="<?php echo $d['IdPegawai'];?>"readonly>
              </div>
              <div class="form-group">
                <label>Nama</label>
              ...
              <div class="form-group">
                <label>NO KTP</label>
                <input class="form-control" type="Text" name="NoKTP"  value="<?php echo $d['NoKTP'];?>">
              </div>
              <div class="form-group">
                <label>Tanggal Lahir</label>
                <input class="form-control" type="date" name="TglLahir"  value="<?php echo $d['TglLahir'];?>">
              </div>
              <div class="form-group">
    ...
    <?php
        if (isset($_POST['ubah'])) {
            ...
            $sql2 = "UPDATE tbpegawai SET IdPegawai = '$idpegawai', nama = '$nama', alamat = '$alamat', NoHP = '$nohp', NoKTP = '$noktp', TglLahir = '$tgllahir', username = '$username', password = '$password' WHERE IdPegawai = '$idpegawai'";

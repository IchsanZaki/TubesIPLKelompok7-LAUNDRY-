...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            ?>
            <a class="btn btn-primary" href="TambahPaket.php" role="button">Input Paket</a>
            <table id="customers" border="1" class="table table-bordered">
                ...
                <tbody>
                    <?php
                        $no=1;
                        $search = @$_POST['search'];
                        $query = mysqli_query($conn,"SELECT *FROM tbpaket");
                        ...
                        <tr>
                            ...
                            <td>$data[harga]</td>
                            <td>
                                <a href='EditPaket.php?id=$data[IdPaket]' >EDIT</a> |
                                <a href='HapusPaket.php?IdPaket=$data[IdPaket]' onClick=\"return confirm('anda yakin?')\">HAPUS</a> 
                            </td>
                        </tr>
                                ";
                                $no++;

...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            ?>
            <a class="btn btn-primary" href="TambahCustomer.php" role="button">Input Customer</a>
                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td>$data[password]</td>
                            <td>
                                <a href='EditCustomer.php?id=$data[IdCustomer]' >EDIT</a> |
                                <a href='HapusCustomer.php?IdCustomer=$data[IdCustomer]' onClick=\"return confirm('anda yakin?')\">HAPUS</a> 
                            </td>
                        </tr>
                                ";
                                $no++;

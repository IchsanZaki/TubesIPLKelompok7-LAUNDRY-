...
<body>
        ...
        <div id="content">
            ...
            <form role="form" method="post" enctype="multipart/form-data" onsubmit="return validasi()" name="biodata">
              <div class="form-group">
                ...
                <input class="form-control" type="Text" name="IdPaket" >
              </div>
              <div class="form-group">
                <label>Jenis Paket</label>
                <input class="form-control" type="Text" name="JenisPaket" >
              </div>
              <div class="form-group">
                <label>harga</label>
    ...
    <?php
        if (isset($_POST['cek'])) {
            ...
            $sql2 = "INSERT INTO tbpaket VALUES('$idpaket','$jenispaket','$harga')";
            $query = mysqli_query($conn, $sql2);
            if ($query) {
                echo "<script>alert('Data Paket telah diinput');</script>";

...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form role="form" method="post" enctype="multipart/form-data" onsubmit="return validasi()" name="biodata">
              ...
              <br>
              <input type="submit" name="cek" value="Input Data" class="btn btn-primary" >
          	</form>
    </div>
    ...
    <?php
        if (isset($_POST['cek'])) {
            ...
            $sql2 = "INSERT INTO tbcustomer VALUES ('$idcustomer','$nama','$alamat','$nohp','$username','$password')";
            $query = mysqli_query($conn, $sql2);
            if ($query) {
                echo "<script>alert('Data Customer telah diinput');</script>";
